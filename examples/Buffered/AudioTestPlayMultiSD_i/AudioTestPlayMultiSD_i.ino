...
void setup() {
  ...
  playRaw1.createBuffer(2048,AudioBuffer::inHeap); // this is pretty fast
  playRaw2.createBuffer(4096,AudioBuffer::inHeap); // this (probably) doesn't take 2x as long as for a 2k buffer!
